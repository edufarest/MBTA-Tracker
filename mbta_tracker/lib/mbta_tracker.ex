defmodule MbtaTracker do
  ...
  # Gets routes and predictions
  def getPredictions!(stopID) do

  	key = "v_ULBvHWlEK0J-_BMEPb_Q"


  	resp = HTTPoison.get!("http://realtime.mbta.com/developer/api/v2/predictionsbystop?api_key=#{key}&stop=#{stopID}&format=json")
    data = Poison.decode!(resp.body)
